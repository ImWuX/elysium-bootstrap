...
namespace mlibc {
    ...
    int sys_tcb_set(void *pointer) {
        syscall1(SYSCALL_FS_SET, (syscall_int_t) pointer);
        return 0;
    }
    ...
    int sys_open(const char *pathname [[maybe_unused]], int flags [[maybe_unused]], mode_t mode [[maybe_unused]], int *fd [[maybe_unused]]) {
        // TODO: Implement
